...
get-childitem 'C:\program files\PackageManagement\*' -directory -Recurse
get-childitem 'C:\program files\PackageManagement\Nuget\*' -directory -Recurse
get-childitem 'C:\program files (x86)\NuGet\*' -directory -Recurse
